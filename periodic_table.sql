...
--
-- Name: elements element_uniq; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT element_uniq UNIQUE (name);
...
ALTER TABLE ONLY public.elements
    ADD CONSTRAINT element_unq UNIQUE (symbol);
